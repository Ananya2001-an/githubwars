        ...
        <>
            <div className="bg">
                    ...
                    <div className="user1">
                        {
                            user1 !== '' && <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <h1>{user1.name}</h1>
                                <p style={{ fontSize: '20px', textAlign:'center' }}>{user1.bio}</p>
                            </div>
                        }
                        {
              ...
              Get
                    ...
                    <div className="user2">
                        {
                            hideInput1 === false && <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}><img src="https://user-images.githubusercontent.com/55504616/217468609-0d6531b4-9251-47c2-919a-7d5f79b9df8a.gif" width="100px" height="100px" alt='loading-gif'/>
                                <p style={{ color: 'var(--theme)', fontSize: '15px', textAlign:'center' }}>Waiting for first player . . .</p></div>
                        }
                        {
                            user2 !== '' && <div style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', alignItems: 'center' }}>
                                ...
                                <h1>{user2.name}</h1>
                                <p style={{ fontSize: '20px', textAlign:'center' }}>{user2.bio}</p>
                            </div>
                        }
                        {
