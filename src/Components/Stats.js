...
export default function Stats(){
    ...
    const {followers:follow_count_1, public_repos:repo_count_1, public_gists:gist_count_1} = user1;
    const {followers:follow_count_2, public_repos:repo_count_2, public_gists:gist_count_2} = user2;
            ...
            <div className='bg'>
                ...
                <div className='stats'>
                    <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'space-evenly'}}>
                        <img src={user1.avatar_url} className="avatar animated-item1" alt="player1"/>
                    ...
                    <div style={{display:'flex', flexDirection:'column', alignItems:'center', justifyContent:'space-evenly'}}>
                        <img src={user2.avatar_url} className="avatar animated-item1" alt="player2"/>
                ...
                <div className='winner'>
                    {user1Wins>user2Wins?user1.name :user1Wins<user2Wins?user2.name:'No one'} wins!
                </div>
                <Confetti
                    width={width}
                    height={height}
